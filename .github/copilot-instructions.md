...
When you need detailed guidance on a specific area:
1. Find the relevant skill in the catalog above
2. Read the skill file to understand patterns and conventions
3. Apply those patterns to your implementation
...
6. **Arrow Parens:** Avoid when possible (`x => x` not `(x) => x`)
