...
import type { Profiles, ProfilesData, ProfilesPatch, ProfilesQuery, ProfilesService } from "./profiles.class"

export type { Profiles, ProfilesData, ProfilesPatch, ProfilesQuery }

export type ProfilesClientService = Pick<ProfilesService<Params<ProfilesQuery>>, (typeof profilesMethods)[number]>
