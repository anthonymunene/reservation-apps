import { component$, type NoSerialize, type QRL, useSignal, useTask$ } from "@builder.io/qwik"
 ...
 * requirements.
 */
export const FileInput = component$(({ value, label, error, ...props }: FileInputProps) => {
